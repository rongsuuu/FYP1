    ...
    if pathname == "/":
        ...
        return html.P(html.Div(children=[html.Div([
            ...
            dash_table.DataTable(
                ...
                row_deletable=True,  # deleting of rows
                sort_by=[]),
                html.Button('RESTRICTED AREA - WMR104', id='RA', n_clicks=0),
                html.Button('DANGER AREA - WSD11 PASIR LABA', id='WSD11', n_clicks=0),
                html.Button('DANGER AREA - WSD11A PASIR LABA', id='WSD11A', n_clicks=0),
                html.Button('DANGER AREA - WSD11B PASIR LABA', id='WSD11B', n_clicks=0),
                html.Button('DANGER AREA - WSD13 AREA KILO', id='WSD13', n_clicks=0),
                html.Button('DANGER AREA - WSD14 AREA LIMA ', id='WSD14', n_clicks=0),
                html.Button('DANGER AREA - WSD15 AREA MIKE', id='WSD15', n_clicks=0),
                html.Button('DANGER AREA - WSD20 AREA HOTEL', id='WSD20', n_clicks=0),
                html.Button('DANGER AREA - WSD34 PULAU TEKONG', id='WSD34', n_clicks=0),
                html.Button('DANGER AREA - WSD44', id='WSD44', n_clicks=0),
                html.Button('DANGER AREA - WSD45', id='WSD45', n_clicks=0),
                html.Button('DANGER AREA - WMD8 CHINA SEA NORTH RANGE', id='WMD8', n_clicks=0),
                html.Button('DANGER AREA - WMD12 AREA JULIET', id='WMD12', n_clicks=0),
                html.Button('DANGER AREA - WMD21 AREA GOLF', id='WMD21', n_clicks=0),
                html.Button('DANGER AREA - WMD224 MALAYSIAN NAVAL EXERCISE AREA ', id='WMD224', n_clicks=0),
                html.Button('DANGER AREA - WMD227 PULAU YU', id='WMD227', n_clicks=0),
                html.Button('DANGER AREA - WMD230 ULU TIRAM (SOUTH)', id='WMD230', n_clicks=0),
                html.Button('DANGER AREA - WMD231 ULU TIRAM (NORTH)', id='WMD231', n_clicks=0),
...
@app.callback(
    Output('graph5_1', 'figure'),
    Input('RA', 'n_clicks'),
    Input('WSD11', 'n_clicks'),
    Input('WSD11A', 'n_clicks'),
    Input('WSD11B', 'n_clicks'),
    Input('WSD13', 'n_clicks'),
    Input('WSD14', 'n_clicks'),
    Input('WSD15', 'n_clicks'),
    Input('WSD20', 'n_clicks'),
    Input('WSD34', 'n_clicks'),
    Input('WSD44', 'n_clicks'),
    Input('WSD45', 'n_clicks'),
    Input('WMD8', 'n_clicks'),
    Input('WMD12', 'n_clicks'),
    Input('WMD21', 'n_clicks'),
    Input('WMD224', 'n_clicks'),
    Input('WMD227', 'n_clicks'),
    Input('WMD230', 'n_clicks'),
    Input('WMD231', 'n_clicks'),)

def clicked_output(RA,WSD11,WSD11A,WSD11B,WSD13,WSD14,WSD15,WSD20,WSD34,WSD44,WSD45,WMD8,WMD12,WMD21,WMD224,WMD227,WMD230,WMD231):
    ctx = dash.callback_context

    if (RA==None)&(WSD11==None)&(WSD11A==None)&(WSD11B==None)&(WSD13==None)&(WSD14==None)&(WSD15==None)&(WSD20==None)&(WSD34==None)&(WSD44==None)&(WSD45==None)&(WMD8==None)&(WMD12==None)&(WMD21==None)&(WMD224==None)&(WMD227==None)&(WMD230==None)&(WMD231==None):
        return ''
    else:
        pie = ctx.triggered[0]['prop_id'].split('.')[0]
        if pie in 'RA':
            ...
            return fig5_1_WSD11A
        elif pie in 'WSD11B':
            return fig5_1_WSD11B
        elif pie in 'WSD13':
            return fig5_1_WSD13
        elif pie == 'WSD14':
            return fig5_1_WSD14
            ...
            return fig5_1_WMD224
        elif pie == 'WMD227':
            return fig5_1_WMD227
        elif pie == 'WMD230':
            return fig5_1_WMD230
        else:
            return fig5_1_WMD231
